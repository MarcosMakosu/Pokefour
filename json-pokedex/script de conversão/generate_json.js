...
fs.writeFileSync('/home/marquinhos/Documentos/projetos/Pokefour/biome_index.json', JSON.stringify(biome_index, null, 2));
fs.writeFileSync('/home/marquinhos/Documentos/projetos/Pokefour/pokemon_data.json', JSON.stringify(pokemon_data, null, 2));

console.error('Files written: biome_index.json and pokemon_data.json');
// Also output a snippet for verification
console.error('biome_index keys (first 5):', Object.keys(biome_index).slice(0, 5));
console.error('pokemon_data keys (first 5):', Object.keys(pokemon_data).slice(0, 5));